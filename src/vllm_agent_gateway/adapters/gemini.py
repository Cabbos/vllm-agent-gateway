    ...
    *,
    ...
    for content_index, content in enumerate(contents):
        ...
        for response_index, function_response in enumerate(function_responses):
            ...
            explicit_id = function_response.get("id")
            response_id: str | None = str(explicit_id) if explicit_id else None
    ...
    if mode == "ANY":
        ...
        tools = [tool for tool in tools if str(tool["function"]["name"]) in allowed_set]
    ...
    elif tools and mode != "NONE":
        request_payload["tools"] = tools
        request_payload["tool_choice"] = "auto"
    return request_payload, events
